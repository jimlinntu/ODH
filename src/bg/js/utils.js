function sanitizeOptions(options) {
    const defaults = {
        ...
        sysscripts: 'builtin_encn_Collins,encn_Collins,encn_Cambridge,encn_Oxford,enen_MerriamWebster,fren_Cambridge,esen_Spanishdict,decn_Eudict,escn_Eudict,frcn_Eudict',
        udfscripts: '',
